...
echo "<h2>
	<br>Registro de Cadastros - $area<br><br>
	</h2>";
echo "<form action=\"fichas.php\" method=\"post\">";
	...
	{			
		...
		echo"<h3>";
	    echo "<input type=\"radio\" value=\"$login_pessoa\" name=\"login_pessoa\" checked=\"checked\">  ".$nome_da_pessoa;
		echo"<br><br>";
		echo"</h3>";
	} 
echo "</select>";
