...
<!-- primeira coluna: menu  ******************************************************************** -->
	...
	<ul class='menu01'>  <!-- a classe menu01 é um estilo css -->
		...
		<li><a 	onclick="window.location.href='menufichas1.php'"	target='blank'	>	Cadastros	</a></li>
		<li><a 	onclick="window.location.href='menuagenda.php'"	target='blank'	>	Agenda	</a></li>
		<li><a 	onclick="window.location.href='menufaltas.php'"	target='blank'	>	Tabela de faltas	</a></li>
		<li><a 	onclick="window.location.href='menudeslig.php'"	target='blank'	>	Desligamentos	</a></li>
		<li><a 	onclick="window.location.href='menuincluir.php'"	target='blank'	>	Incluir Voluntário</a></li>
		<li><a 	onclick="window.location.href='menuindireto.php'"	target='blank'	>	Ver voluntários indiretos	</a></li>
