...
<div class="largo-div">
	...
	<br><br>
	<h2>
	<br>Acesso ao registro dos voluntários indiretos<br><br>
	</h2>
	<ft><br><br>
	<tr>
<?php echo "<form action=\"fichas_indireto.php\" method=\"post\">";
echo "<select name=\"login_pessoa\">";
	$pessord = nomes_vi ($link);
...
echo "</select>";
echo "<br/><br/><br/><br/>";
echo "<input type=\"submit\" value=\"Ver dados\">";
echo "</form>";
